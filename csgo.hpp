...
// 2021-08-13 14:28:01.916530100 UTC
...
constexpr ::std::ptrdiff_t m_totalHitsOnServer = 0xA3A8;
...
constexpr ::std::ptrdiff_t find_hud_element = 0x312FF720;
...
constexpr ::std::ptrdiff_t ptrEntityList = 0x38DE12C;
